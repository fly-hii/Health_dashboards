...
export default function Header({ searchTerm, setSearchTerm, isSidebarMinimized, setIsSidebarMinimized }) {
  ...
  return (
    <header className={`fixed top-0 right-0 z-30 flex items-center justify-between h-header px-8 bg-white border-b border-slate-200 shadow-sm transition-all duration-300 ${isSidebarMinimized ? 'w-[calc(100vw-72px)]' : 'w-[calc(100vw-260px)]'
      }`}>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Search Input */}
        <div className="flex items-center gap-3 w-96 px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/10 transition-all">
